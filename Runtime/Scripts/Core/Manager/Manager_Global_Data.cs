...
namespace IbrahKit
{
    public abstract class Manager_Global_Data<TManager, TData> : Manager_Global<TManager> where TData : ScriptableObject where TManager : Manager_Global_Data<TManager, TData>
    {
