...
namespace IbrahKit.UI
{
    ...
    public class UI_Configs
    {
        ...
        {
            return Type_Utilities.GetAllTypes(typeof(Override_Config_SO_Base)).Except(Type_Utilities.GetTypesInCollection(overrides)).Where(x => !x.ContainsGenericParameters);
        }
