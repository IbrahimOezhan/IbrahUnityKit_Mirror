...
//     version 1.14.2
//     from Assets/Toolkit/IbrahKit_Core/Runtime/Scripts/Pause/Input/Pause.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Toolkit/IbrahKit_Core/Runtime/Scripts/Pause/Input/Pause.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Pause: IInputActionCollection2, IDisposable
{
    ...
    ~@Pause()
    {
        UnityEngine.Debug.Assert(!m_Map.enabled, "This will cause a leak and performance issues, Pause.Map.Disable() has not been called.");
    }
    ...
    public struct MapActions
    {
        ...
        /// </summary>
        public MapActions(@Pause wrapper) { m_Wrapper = wrapper; }
        /// <summary>
