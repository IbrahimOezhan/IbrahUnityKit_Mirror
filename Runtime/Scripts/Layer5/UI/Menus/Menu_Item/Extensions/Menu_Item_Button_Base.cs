...
namespace IbrahKit.UI
{
    ...
    public abstract class Menu_Item_Button_Base : Menu_Item_Base
    {
        ...
        [SerializeField, ShowIf(nameof(localType), LocalType.LOCALIZE)]
        private Local_Key localizationKey;

        [SerializeField, ShowIf(nameof(localType), LocalType.STATIC)]
        ...
        protected abstract bool TrySpawnProPro(RectTransform parent, UI_Menu menu,
