...
//     version 1.19.0
//     from Assets/Plugins/IbrahKit_Core/Runtime/Scripts/Layer4/Pause/Input/Pause_Input.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Plugins/IbrahKit_Core/Runtime/Scripts/Layer4/Pause/Input/Pause_Input.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Pause_Input: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Map"",
            ""id"": ""545952e3-3194-48cb-b7c4-a6f235fcc21f"",
            ""actions"": [
                {
                    ""name"": ""Toggle"",
                    ""type"": ""Button"",
                    ""id"": ""8c472540-4c51-4afb-b86c-a57f27fbdad3"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""ff9b79ef-044e-4eef-8ac3-c4eefb8a6a21"",
    ...
    ~@Pause_Input()
    {
        UnityEngine.Debug.Assert(!m_Map.enabled, "This will cause a leak and performance issues, Pause_Input.Map.Disable() has not been called.");
    }
    ...
    {
        private @Pause_Input m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MapActions(@Pause_Input wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Map/Toggle".
        /// </summary>
